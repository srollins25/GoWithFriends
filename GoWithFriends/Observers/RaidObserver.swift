        ...
        db.collection("raids").addSnapshotListener { (snap, error) in
            ...
            for i in snap!.documentChanges {
                ...
                if(i.type == .added){
                    ...
                    let timeTillStart = i.document.get("timeTillStart") as! NSNumber
                    ...
                    if((Date().timeIntervalSince1970 as NSNumber).doubleValue >= timeToRemove.doubleValue || (Date().timeIntervalSince1970 as NSNumber).doubleValue >= timeTillStart.doubleValue)
                    {

...
//                    }
    ...
    func getPokemon()
    {
        ...
        self.pokemon.append(MapPkm(name: "Foongus", dexnum: "590"))
        self.pokemon.append(MapPkm(name: "Amoonguss", dexnum: "591"))
        self.pokemon.append(MapPkm(name: "Frillish", dexnum: "592"))
        self.pokemon.append(MapPkm(name: "Jellicent", dexnum: "593"))
        self.pokemon.append(MapPkm(name: "Alomomola", dexnum: "594"))
        self.pokemon.append(MapPkm(name: "Joltik", dexnum: "559"))
        self.pokemon.append(MapPkm(name: "Galvantula", dexnum: "596"))
        self.pokemon.append(MapPkm(name: "Ferroseed", dexnum: "597"))
        self.pokemon.append(MapPkm(name: "Ferrothorn", dexnum: "598"))
        self.pokemon.append(MapPkm(name: "Klink", dexnum: "599"))
        self.pokemon.append(MapPkm(name: "Klang", dexnum: "600"))
        self.pokemon.append(MapPkm(name: "Klinklang", dexnum: "601"))
        self.pokemon.append(MapPkm(name: "Tynamo", dexnum: "602"))
        self.pokemon.append(MapPkm(name: "Eelektrik", dexnum: "603"))
        self.pokemon.append(MapPkm(name: "Eelektross", dexnum: "604"))
        self.pokemon.append(MapPkm(name: "Elgyem", dexnum: "605"))
        self.pokemon.append(MapPkm(name: "Beheeyem", dexnum: "606"))
        self.pokemon.append(MapPkm(name: "Litwick", dexnum: "607"))
        self.pokemon.append(MapPkm(name: "Lampent", dexnum: "608"))
        self.pokemon.append(MapPkm(name: "Chandelure", dexnum: "609"))
        self.pokemon.append(MapPkm(name: "Axew", dexnum: "610"))
        self.pokemon.append(MapPkm(name: "Fraxure", dexnum: "611"))
        self.pokemon.append(MapPkm(name: "Haxorus", dexnum: "612"))
        self.pokemon.append(MapPkm(name: "Cubchoo", dexnum: "613"))
        self.pokemon.append(MapPkm(name: "Beartic", dexnum: "614"))
        self.pokemon.append(MapPkm(name: "Cryogonal", dexnum: "615"))
        self.pokemon.append(MapPkm(name: "Shelmet", dexnum: "616"))
        self.pokemon.append(MapPkm(name: "Accelgor", dexnum: "617"))
        self.pokemon.append(MapPkm(name: "Stunfusk", dexnum: "618"))
        self.pokemon.append(MapPkm(name: "Mienfoo", dexnum: "619"))
        self.pokemon.append(MapPkm(name: "Mienshao", dexnum: "620"))
        self.pokemon.append(MapPkm(name: "Druddigon", dexnum: "621"))
        self.pokemon.append(MapPkm(name: "Golett", dexnum: "622"))
        self.pokemon.append(MapPkm(name: "Golurk", dexnum: "623"))
        self.pokemon.append(MapPkm(name: "Pawniard", dexnum: "624"))
        self.pokemon.append(MapPkm(name: "Bisharp", dexnum: "625"))
        self.pokemon.append(MapPkm(name: "Bouffalant", dexnum: "626"))
        self.pokemon.append(MapPkm(name: "Rufflet", dexnum: "627"))
        self.pokemon.append(MapPkm(name: "Braviary", dexnum: "628"))
        self.pokemon.append(MapPkm(name: "Vullaby", dexnum: "629"))
        self.pokemon.append(MapPkm(name: "Mandibuzz", dexnum: "630"))
        self.pokemon.append(MapPkm(name: "Heatmor", dexnum: "631"))
        self.pokemon.append(MapPkm(name: "Durant", dexnum: "632"))
        self.pokemon.append(MapPkm(name: "Deino", dexnum: "633"))
        self.pokemon.append(MapPkm(name: "Zweilous", dexnum: "634"))
        self.pokemon.append(MapPkm(name: "Hydreigon", dexnum: "635"))
        self.pokemon.append(MapPkm(name: "Larvesta", dexnum: "636"))
        self.pokemon.append(MapPkm(name: "Volcarona", dexnum: "637"))
